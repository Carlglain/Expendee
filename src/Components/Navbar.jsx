...
function Navbar() {
  ...
  const MenuCustom = ()=>{
    return(
      <div className='flex lg:hidden flex-col w-50 bg-gray-50 rounded-md p-4 fixed top-15 text-center right-0 justify-center items-center '>
  ...
  return (
    <nav className='top-0 sticky text-black w-full h-15 py-3 bg-gray-50 text-lg'>
