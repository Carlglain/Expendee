...
const Review =({reviews})=>{
  ...
  return(
    ...
    <div className='lg:h-90 bg-white text-xl lg:flex-[1_1_30%]  p-6 rounded-md  shadow-lg flex flex-col '>
      {icon}<br />
      <h2>{content}</h2>
      {user}
    </div>
...
function ReviewsSection() {
  return (
    <div>
      ...
      <div className='flex justify-center max-w-7xl items-center gap-10  flex-wrap mx-auto my-auto '>
        {reviews.map((Rev)=>(
